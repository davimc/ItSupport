...
public record DeviceDTO(UUID id, LocalDateTime createdAt,String type, String brand,String model, String characteristics,String obs)
{
    public DeviceDTO(Device obj){
        this(obj.getId(),obj.getCreatedAt(), obj.getType().getDesc(),obj.getBrand(), obj.getModel(), obj.getCharacteristics(), obj.getObs());
    }
}
