...
public record PartDTO(UUID id, double price, Double percentage, double salePrice, Integer quantity, String local) {
    public PartDTO (Part obj){
        this(obj.getId(), obj.getPrice(), (obj.getPercentageSale()*100),
